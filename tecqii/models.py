...
class User(models.Model):
    ...
    facebook_id = models.CharField(max_length=256, blank=True, default='') # Facebook ID
    ...
    github_login_name = models.CharField(max_length=256, blank=True, default='') # GitHub ID
    user_id = models.CharField(max_length=256, unique=True) # ユーザID
    items_count = models.IntegerField(default=0, db_index=True) # このユーザが qiita.com 上で公開している投稿の数
    linkedin_id = models.CharField(max_length=256, blank=True, default='')
    location = models.CharField(max_length=256, blank=True, default='', db_index=True)
    name = models.CharField(max_length=256, blank=True, null=True, db_index=True)
    organization = models.CharField(max_length=256, blank=True, null=True, db_index=True)
    ...
    twitter_screen_name = models.CharField(max_length=256, blank=True, default='') # Twitterのスクリーンネーム
